...
import { setTokens, setUserData, getErrorMessage, validateEmail } from '../utils/auth';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Generate email from username for demo purposes
      const registrationData = {
        ...formData,
        email: `${formData.username}@securebank.demo`
      };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {/* Registration Form */}
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Create New Account</h3>
            <p className="text-gray-600 mb-6">Join SecureBank and start managing your finances today</p>
          ...
          <div className="mt-8 text-center text-xs text-gray-500">
            © 2025 SecureBank. Demo application for educational purposes.
          </div>
        </div>
      </div>
    </div>
